const virtual_hook = {
  init: function() {
    this.appendDummyInput('vh')
      .appendField(new Blockly.FieldLabelSerializable('Set Virtual Hook Settings:'), 'svhs');
    this.appendStatementInput('vhs');
...
Blockly.common.defineBlocks({virtual_hook: virtual_hook});

python.pythonGenerator.forBlock['virtual_hook'] = function() {
  const statement_vhs = generator.statementToCode(block, 'vhs');
...
const Enable_Martingale = {
  init: function() {
    this.appendDummyInput('emdu')
      .appendField(new Blockly.FieldLabelSerializable('Enable Martingale'), 'emd')
...
Blockly.common.defineBlocks({Enable_Martingale: Enable_Martingale});

python.pythonGenerator.forBlock['Enable_Martingale'] = function() {
  const dropdown_md = block.getFieldValue('md');
...
const Martingale_Factor = {
  init: function() {
    this.appendDummyInput('mfd')
      .appendField(new Blockly.FieldLabelSerializable('Martingale Factor'), 'mfl')
      .appendField(new Blockly.FieldNumber(1.5), 'mfn');
    this.setInputsInline(true)
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('');
...
Blockly.common.defineBlocks({Martingale_Factor: Martingale_Factor});


python.pythonGenerator.forBlock['Martingale_Factor'] = function() {
  const number_mfn = block.getFieldValue('mfn');
...
const Max_Steps = {
  init: function() {
    this.appendDummyInput('msd')
      .appendField(new Blockly.FieldLabelSerializable('Max Steps'), 'msl')
      .appendField(new Blockly.FieldNumber(3), 'msv');
    this.setInputsInline(true)
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('');
...
Blockly.common.defineBlocks({Max_Steps: Max_Steps});

python.pythonGenerator.forBlock['Max_Steps'] = function() {
  const number_msv = block.getFieldValue('msv');
...
const Min_Trades = {
  init: function() {
    this.appendDummyInput('mtd')
      .appendField(new Blockly.FieldLabelSerializable('Min. Trades on Real'), 'mtl')
      .appendField(new Blockly.FieldNumber(1), 'mtv');
    this.setInputsInline(true)
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('');
...
Blockly.common.defineBlocks({Min_Trades: Min_Trades});


python.pythonGenerator.forBlock['Min_Trades'] = function() {
  const number_mtv = block.getFieldValue('mtv');
...
const Authorize_your_VH_token = {
  init: function() {
    this.appendDummyInput('ttd')
      .appendField(new Blockly.FieldLabelSerializable('Authorize your VH token'), 'aytvtl')
      .appendField(new Blockly.FieldTextInput('--Token--'), 'tt');
    this.setInputsInline(true)
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('');
...
Blockly.common.defineBlocks({Authorize_your_VH_token: Authorize_your_VH_token});

python.pythonGenerator.forBlock['Authorize_your_VH_token'] = function() {
  const text_tt = block.getFieldValue('tt');
...
const Enable_Disable_VH = {
  init: function() {
    this.appendDummyInput('edd')
      .appendField(new Blockly.FieldLabelSerializable('Enable/Disable VH'), 'edl')
      .appendField(new Blockly.FieldDropdown([
          ['diable', 'OPTIONNAME'],
          ['enable', 'OPTIONNAME']
        ]), 'ed');
...
Blockly.common.defineBlocks({Enable_Disable_VH: Enable_Disable_VH});

python.pythonGenerator.forBlock['Enable_Disable_VH'] = function() {
  const dropdown_ed = block.getFieldValue('ed');
...
const VirtualHook_Status = {
  init: function() {
    this.appendDummyInput('vhsd')
      .appendField(new Blockly.FieldLabelSerializable('VirtualHook Status'), 'vhsl');
    this.setInputsInline(true)
...
Blockly.common.defineBlocks({VirtualHook_Status: VirtualHook_Status});

python.pythonGenerator.forBlock['VirtualHook_Status'] = function() {
...
python.pythonGenerator.forBlock['Multiplier'] = function(block) {
  ...
  // TODO: Assemble python into the code variable.
  //const code = '...';
  const code = `\n# Python code for Multiplier_block\ndef Multiplier_block(stake, option):\n${statement_mts}\n  variables = locals().copy()\n  return variables\nMultiplier = Multiplier_block(${number_stv}, ${dropdown_mvdd})\nprint("executed ${mtl}:", Multiplier)`;
...
const vhBlocks =`
    <xml xmlns="http://www.w3.org/1999/xhtml">
      <block type="virtual_hook" x="10" y="10">
        <statement name="vhs">
          <block type="Enable_Martingale">
            <next>
              <block type="Martingale_Factor">
                <next>
                  <block type="Max_Steps">
                    <next>
                      <block type="Min_Trades">
                        <next>
                          <block type="Take_profitt">
                            <next>
                              <block type="Stop_Losss"></block>
                            </next>
                          </block>
                        </next>
                      </block>
      ...
      <block id="trade_param_3" type="Authorize_your_VH_token" x="10" y="10"></block>
      <block id="trade_param_4" type="Enable_Disable_VH" x="10" y="10"></block>
      <block id="trade_param_5" type="VirtualHook_Status" x="10" y="10"></block>
    </xml>
`;
