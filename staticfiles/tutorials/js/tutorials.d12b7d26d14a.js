...
function loadInlineChart(containerId = 'chart-page-container') {
    ...
    const iconData = [
        { src: 'line-graph.png', label: 'Chart types' },
        { src: 'economic-indicators.png', label: 'Indicators' },
        { src: 'template.png', label: 'Templates' },
        { src: 'pencil (1).png', label: 'Drawing tools' },
        { src: 'download-file.png', label: 'Download' }
    ];
    ...
    iconData.forEach(({ src, label }) => {
        ...
        wrapper.addEventListener('click', () => {
            ...
            if (label === 'Chart types') {
                ...
                const chartOptions = [
                    { icon: 'area-chart.png', name: 'Area' },
                    { icon: 'candlestick-chart.png', name: 'Candlestick' },
                    { icon: 'candlestick-chart (1).png', name: 'Hollow' },
                    { icon: 'buy.png', name: 'OHLC' }
                ];
