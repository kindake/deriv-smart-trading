...
const Simple_Moving_Average__SMA_ = {
  init: function() {
    this.appendDummyInput('sma')
      .appendField(new Blockly.FieldLabelSerializable('set'), 'smal')
      .appendField(new Blockly.FieldVariable('sma'), 'sma')
      .appendField(new Blockly.FieldLabelSerializable(' to Simple Moving Average   '), 'NAME');
...
python.pythonGenerator.forBlock['Simple_Moving_Average__SMA_'] = function() {
  const variable_sma = generator.getVariableName(block.getFieldValue('sma'));

  const statement_smas = generator.statementToCode(block, 'smas');

  // TODO: Assemble python into the code variable.
  //const code = '...';
  const code = `
\n# Python code for sma\n${variable_sma} = ${statement_smas}
`;
...
const Simple_Moving_Average_Array__SMAA_ = {
  init: function() {
    this.appendDummyInput('smaa')
      .appendField(new Blockly.FieldLabelSerializable('set'), 'smaal')
      .appendField(new Blockly.FieldVariable('smaa'), 'smaa')
      .appendField(new Blockly.FieldLabelSerializable(' to Simple Moving Average Array  '), 'NAME');
...
python.pythonGenerator.forBlock['Simple_Moving_Average_Array__SMAA_'] = function() {
  const variable_smaa = generator.getVariableName(block.getFieldValue('smaa'));

  const statement_smaas = generator.statementToCode(block, 'smaas');

  // TODO: Assemble python into the code variable.
  //const code = '...';
  const code = `
\n# Python code for smaa\n${variable_smaa} = ${statement_smaas}
`;
  return code;
}
...
const Bollinger_Bands__BB_ = {
  init: function() {
    this.appendDummyInput('bb')
      .appendField(new Blockly.FieldLabelSerializable('set'), 'bbl')
      .appendField(new Blockly.FieldVariable('bb'), 'bb')
      .appendField(new Blockly.FieldLabelSerializable(' to Bollinger Bands   '), 'NAME')
      .appendField(new Blockly.FieldVariable('middle'), 'mn');
...
python.pythonGenerator.forBlock['Bollinger_Bands__BB_'] = function() {
  const variable_bb = generator.getVariableName(block.getFieldValue('bb'));
  const variable_mn = generator.getVariableName(block.getFieldValue('mn'));

  const statement_bbs = generator.statementToCode(block, 'bbs');

  // TODO: Assemble python into the code variable.
  //const code = '...';
  const code = `
\n# Python code for bb\n${variable_bb}, ${variable_mn} = ${statement_smas}
`;
  return code;
}
...
const Bollinger_Bands_Array__BBA_ = {
  init: function() {
    this.appendDummyInput('bba')
      ...
      .appendField(new Blockly.FieldLabelSerializable(' to Bollinger Bands Array   '), 'NAME')
      .appendField(new Blockly.FieldVariable('middle'), 'mna');
...
python.pythonGenerator.forBlock['Bollinger_Bands_Array__BBA_'] = function() {
  const variable_bba = generator.getVariableName(block.getFieldValue('bba'));
  const variable_mna = generator.getVariableName(block.getFieldValue('mna'));

  const statement_bbas = generator.statementToCode(block, 'bbas');

  // TODO: Assemble python into the code variable.
  //const code = '...';
const code = `
\n# Python code for bba\n${variable_bba}, ${variable_mna} = ${statement_bbas}
`;
  return code;
}
...
const Exponential_Moving_Average__EMA_ = {
  init: function() {
    this.appendDummyInput('ema')
      .appendField(new Blockly.FieldLabelSerializable('set'), 'emal')
      .appendField(new Blockly.FieldVariable('ema'), 'ema')
      .appendField(new Blockly.FieldLabelSerializable(' to Exponential Moving Average   '), 'NAME');
...
python.pythonGenerator.forBlock['Exponential_Moving_Average__EMA_'] = function() {
  const variable_ema = generator.getVariableName(block.getFieldValue('ema'));

  const statement_emas = generator.statementToCode(block, 'emas');

  // TODO: Assemble python into the code variable.
  //const code = '...';
  const code = `
\n# Python code for ema\n${variable_ema} = ${statement_emas}
`;
  return code;
}
...
python.pythonGenerator.forBlock['Exponential_Moving_Average_Array__EMAA_'] = function() {
  const variable_emaa = generator.getVariableName(block.getFieldValue('emaa'));

  const statement_emaas = generator.statementToCode(block, 'emaas');

  // TODO: Assemble python into the code variable.
  //const code = '...';
  const code = `
\n# Python code for emaa\n${variable_emaa} = ${statement_emaas}
`;
  return code;
}
...
const Relative_Strength_Index__RSI_ = {
  init: function() {
    this.appendDummyInput('rsi')
      .appendField(new Blockly.FieldLabelSerializable('set'), 'rsil')
      .appendField(new Blockly.FieldVariable('rsi'), 'rsi')
      .appendField(new Blockly.FieldLabelSerializable(' to Relative Strength Index  '), 'NAME');
...
python.pythonGenerator.forBlock['Relative_Strength_Index__RSI_'] = function() {
  const variable_rsi = generator.getVariableName(block.getFieldValue('rsi'));

  const statement_rsis = generator.statementToCode(block, 'rsis');

  // TODO: Assemble python into the code variable.
  //const code = '...';
  const code = `
\n# Python code for rsi\n${variable_rsi} = ${statement_rsis}
`;
  return code;
}
...
const Relative_Strength_Index_Array__RSIA_ = {
  init: function() {
    this.appendDummyInput('rsia')
      .appendField(new Blockly.FieldLabelSerializable('set'), 'rsial')
      .appendField(new Blockly.FieldVariable('rsia'), 'rsia')
      .appendField(new Blockly.FieldLabelSerializable(' to Relative Strength Index Array  '), 'NAME');
...
python.pythonGenerator.forBlock['Relative_Strength_Index_Array__RSIA_'] = function() {
  const variable_rsia = generator.getVariableName(block.getFieldValue('rsia'));

  const statement_rsias = generator.statementToCode(block, 'rsias');

  // TODO: Assemble python into the code variable.
  //const code = '...';
  const code = `
\n# Python code for rsia\n${variable_rsia} = ${statement_rsias}
`;
  return code;
}
...
const Moving_Average_Convergence_Divergence = {
  init: function() {
    this.appendDummyInput('macda')
      .appendField(new Blockly.FieldLabelSerializable('set'), 'macdal')
      .appendField(new Blockly.FieldVariable('macda'), 'macda')
      .appendField(new Blockly.FieldLabelSerializable(' to MACD Array  '), 'NAME')
      .appendField(new Blockly.FieldVariable('MACD'), 'macdn');
    this.appendStatementInput('macdas');
    this.setInputsInline(true)
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('');
...
python.pythonGenerator.forBlock['Moving_Average_Convergence_Divergence'] = function() {
  const variable_macda = generator.getVariableName(block.getFieldValue('macda'));
  const variable_macdn = generator.getVariableName(block.getFieldValue('macdn'));

  const statement_macdas = generator.statementToCode(block, 'macdas');

  // TODO: Assemble python into the code variable.
  //const code = '...';
const code = `
\n# Python code for macda\n${variable_macda}, ${variable_macdn} = ${statement_macdas}
`;
  return code;
}
...
python.pythonGenerator.forBlock['input_List'] = function() {
  // TODO: change Order.ATOMIC to the correct operator precedence strength
  const value_ilv = generator.valueToCode(block, 'ilv', python.Order.ATOMIC);
...
python.pythonGenerator.forBlock['Period_'] = function() {
...
python.pythonGenerator.forBlock['Run_on_every_tick'] = function() {
...
python.pythonGenerator.forBlock['Last_tick'] = function() {
...
python.pythonGenerator.forBlock['Last_Digit'] = function() {
...
python.pythonGenerator.forBlock['Current_Stat'] = function() {
...
python.pythonGenerator.forBlock['Current_stat_list'] = function() {
...
python.pythonGenerator.forBlock['Tick_list'] = function() {
  const csl = block.getFieldValue('tll');
...
python.pythonGenerator.forBlock['Market_direction'] = function() {
  const dropdown_did = block.getFieldValue('did');
...
python.pythonGenerator.forBlock['Is_candle_black_'] = function() {
  // TODO: change Order.ATOMIC to the correct operator precedence strength
  const value_icbv = generator.valueToCode(block, 'icbv', python.Order.ATOMIC);
  const csl = block.getFieldValue('csl');
