...
/*
    ...
    updateOptionsScroll();  // Initial call
*/
/*
    const optionsDiv = document.createElement('div');
    optionsDiv.id = 'optionsDiv';
    ...
    function updateOptionsScroll() {
        if (window.innerWidth < 700) {
            ...
            // ✅ Ensure children don't shrink so they can scroll
    ...
    // Make layout responsive on resize
    function updateSecondOptionsLayout() {
        if (window.innerWidth < 700) {
            secondOptionsDiv.style.left = '110px';
            secondOptionsDiv.style.width = '289px';

            // Quick Strategy button adjustments for small screens
            quickStrategyBtn.style.width = '100px';
            quickStrategyBtn.style.left = '5px';
        } else {
            secondOptionsDiv.style.left = '17.55vw'; // matches optionsDiv width
            secondOptionsDiv.style.width = '36.2vw';

            // Quick Strategy button adjustments for large screens
            quickStrategyBtn.style.width = '16.1vw';
            quickStrategyBtn.style.left = '0.7vw';
        }
    }

    window.addEventListener('resize', updateSecondOptionsLayout);
    updateSecondOptionsLayout(); // Initial call
    ...
    // Step 2: Update width on resize
    function updateSODivLayout() {
        if (window.innerWidth < 700) {
    ...
    updateSODivLayout();
    window.addEventListener('resize', updateSODivLayout);

    // Step 3: Responsive icon groups
    ...
    // Append sODiv to secondOptionsDiv
    secondOptionsDiv.appendChild(sODiv);

    // Append secondOptionsDiv inside optionsDiv
    optionsDiv.appendChild(secondOptionsDiv);

    // Append only optionsDiv to wrapper
    const wrapper = document.getElementById('blocklyWrapper');
    wrapper.appendChild(optionsDiv);

    // Responsive position for secondOptionsDiv
    function updateSecondOptionsLayout() {
        if (window.innerWidth < 700) {
            secondOptionsDiv.style.left = '115px';
            secondOptionsDiv.style.width = '289px';
        } else {
            secondOptionsDiv.style.left = '17.5vw';
            secondOptionsDiv.style.width = '36.2vw';
        }
    }
...
*/
    ...
    /*function updateLayout() {
        if (window.innerWidth < 700) {
            ...
            // Second Options Div
            secondOptionsDiv.style.left = '10px';  //
            secondOptionsDiv.style.width = '289px';
            ...
            // Second Options Div
            secondOptionsDiv.style.left = '1.55vw'; // '17.55vw';
            secondOptionsDiv.style.width = '36.2vw';
...
/*    function updateLayout() {
        if (window.innerWidth < 700) {
            ...
            optionsDiv.style.overflowX = 'auto';
            optionsDiv.style.overflowY = 'hidden';
            optionsDiv.style.width = '100%'; // allow container viewport to be smaller than content
            optionsDiv.classList.add('hide-scrollbar');

            [...optionsDiv.children].forEach(child => {
                child.style.flexShrink = '0'; // stops shrinking
            });
...
*/
 /*   const myDiv = document.createElement('div');
    ...
    myDiv.style.top = '9vh';
    myDiv.style.left = '0.7vw';
    myDiv.style.height = '7vh';
    myDiv.style.width = '21.1vw';
    // myDiv.style.width = '92%';
    ...
    myDiv.style.zIndex = '9';                 // lower z-index
...
*/
    ...
    // Append the existing toggle button (if it’s separate)
    //wrapper.appendChild(blocksMenuToggleBtn);
    ...
    blocksMenuToggleBtn.appendChild(toggleIcon);
    blocksMenuToggleBtn.appendChild(buttonText);
    //document.getElementById('blocklyWrapper').appendChild(blocksMenuToggleBtn);
    // Append children
    //const wrapper = document.getElementById('blocklyWrapper');
    wrapper.appendChild(blocksMenuToggleBtn);
    // ✅ Responsive function
    function updateBlocksMenuStyles() {
        if (window.innerWidth < 700) {
            ...
            blocksMenuToggleBtn.style.left = '5px';
...
*/
    ...
    sections.forEach((sectionName) => {
       /* const sectionDiv = document.createElement('div');
        ...
        toggleSectionIcon.style = 'width: 3.5vh; height: 3.5vh; margin-right: 18vh;'; // margin-left: 18vh;';
        ...
        if (sectionName === 'Analysis') {
            toggleSectionIcon.style = 'width: 3.5vh; height: 3.5vh; margin-right: 0.5vw;'; // margin-left: 8.5vw;';
            sectionDiv.appendChild(toggleSectionIcon);
        };

        if (sectionName === 'Utility') {
            toggleSectionIcon.style = 'width: 3.5vh; height: 3.5vh; margin-right: 0.2vw;'; // margin-left: 9.2vw;';
...
*/
        ...
        const toggleSectionIcon = document.createElement('img');
        toggleSectionIcon.src = '/static/icons/down.png';
        toggleSectionIcon.style.width = '3.5vh';
        toggleSectionIcon.style.height = '3.5vh';
        toggleSectionIcon.style.marginLeft = 'auto'; // pushes icon to far right
