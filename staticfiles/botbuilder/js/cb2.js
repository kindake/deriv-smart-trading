...
python.pythonGenerator.forBlock['Current_stat_list'] = function(block) {
  ...
  //const code = '...';
const code = `
\nCurrent_stat_list = Current_stat_list
`;
  // TODO: Change Order.NONE to the correct operator precedence strength
  return [code, python.Order.NONE];
}
...
python.pythonGenerator.forBlock['Last_Digits_List'] = function() {
  ...
  //const code = '...';
const code = `
\nLast_Digits_List = Last_Digits_List
`;
  // TODO: Change Order.NONE to the correct operator precedence strength
  return [code, python.Order.NONE];
}
...
python.pythonGenerator.forBlock['Market_direction'] = function() {
  ...
  //const code = '...';
const code = `
\nMarket_direction = ${dropdown_mddd}
`;
  // TODO:  Order.NONE to the correct operator precedence strength
  return [code, python.Order.NONE];
}
...
python.pythonGenerator.forBlock['Is_candle_black_'] = function(block) {
  ...
  const csl = block.getFieldValue('csl');
9  // TODO: Assemble python into the code variable.
  //const code = '...';
  const code = `
\nIs_candle_black_ = ${value_icbv}
`;
  // TODO: Change Order.NONE to the correct operator precedence strength
  return [code, python.Order.NONE];
}
...
python.pythonGenerator.forBlock['Read_candle_value__2_'] = function() {
  ...
  // TODO: change Order.ATOMIC to the correct operator precedence strength
  const value_rcv2v = generator.valueToCode(block, 'rcv2v', python.Order.ATOMIC);
...
python.pythonGenerator.forBlock['Create_a_list_of_candle_values__2_'] = function() {
  ...
  // TODO: change Order.ATOMIC to the correct operator precedence strength
  const value_calocv2v = generator.valueToCode(block, 'calocv2v', python.Order.ATOMIC);
...
python.pythonGenerator.forBlock['Last_trade_result'] = function() {
  ...
  //const code = '...';
  const code = `
  \nLast_trade_result = Last_trade_result(${dropdown_ltrd})
`;
  // TODO: Change Order.NONE to the correct operator precedence strength
  return [code, python.Order.NONE];
}
...
python.pythonGenerator.forBlock['Contract_details'] = function() {
  ...
  //const code = '...';
  const code = `
 \nContract_details = Contract_details(${dropdown_cddd})
`;
  // TODO: Change Order.NONE to the correct operator precedence strength
  return [code, python.Order.NONE];
}
...
python.pythonGenerator.forBlock['Profit_loss_from_selling'] = function() {
  ...
  //const code = '...';
  const code = `
\nProfit_loss_from_selling = Profit_loss_from_selling()
`;
  // TODO: Change Order.NONE to the correct operator precedence strength
  return [code, python.Order.NONE];
}
...
python.pythonGenerator.forBlock['Can_contract_be_sold_'] = function() {
  ...
  //const code = '...';
  const code = `
\nCan_contract_be_sold_ = Can_contract_be_sold_()
`;
  // TODO: Change Order.NONE to the correct operator precedence strength
  return [code, python.Order.NONE];
}
...
python.pythonGenerator.forBlock['Potential_payout'] = function() {
  ...
  //const code = '...';
  const code = `
\nPotential_payout = Potential_payout(${dropdown_ppdd})
`;
  // TODO: Change Order.NONE to the correct operator precedence strength
  return [code, python.Order.NONE];
}
...
python.pythonGenerator.forBlock['Purchase_price'] = function() {
  ...
  //const code = '...';
  const code = `
\nPurchase_price = Purchase_price(${dropdown_pupdd})
`;
  // TODO: Change Order.NONE to the correct operator precedence strength
  return [code, python.Order.NONE];
}
...
python.pythonGenerator.forBlock['Account_balance'] = function() {
  ...
  //const code = '...';
  const code = `
\nAccount_balance = Account_balance(${dropdown_pupdd})
`;
  // TODO: Change Order.NONE to the correct operator precedence strength
  return [code, python.Order.NONE];
}
...
python.pythonGenerator.forBlock['Function_1'] = function() {
  ...
  //const code = '...';
  const code = `
\n# Python code for Function_1_block\ndef Function_1_block():\n${statement_fs}\n  variables = locals().copy()\n  return variables\nFunction_1 = Function_1_block()\nprint("executed Function_1:", Function_1)
`;
  return code;
}
...
python.pythonGenerator.forBlock['Function_that_returns_a_value'] = function() {
  const ftravv = block.getFieldValue('ftravv');

  const statement_ftravv = generator.statementToCode(block, 'ftravv);

  // TODO: Assemble python into the code variable.
  //const code = '...';
  const code = `
\n# Python code for Function_that_returns_a_value_block\ndef Function_that_returns_a_value_block():\n${statement_ftravv}\n variables = locals().copy()\n  return ${ftravv}\nreturns_value = Function_that_returns_a_value_block()\nprint("executed Function_that_returns_a_value:", returns_value)
`;
  return code;
}
...
python.pythonGenerator.forBlock['Conditional_return'] = function() {
  // TODO: change Order.ATOMIC to the correct operator precedence strength
  const value_civ = generator.valueToCode(block, 'civ', python.Order.ATOMIC);

  // TODO: change Order.ATOMIC to the correct operator precedence strength
  const value_crv = generator.valueToCode(block, 'crv', python.Order.ATOMIC);
